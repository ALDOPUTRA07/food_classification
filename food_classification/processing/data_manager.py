...
from food_classification.model import auto_transform, load_pretrained_model
...
def load_data():
    ...
    test_data = datasets.ImageFolder(root=data_train, transform=auto_transforms)
...
def data_loader(batch, num_worker):
    ...
    test_dataloader = DataLoader(
        dataset=test_data, batch_size=batch, num_workers=num_worker, shuffle=False
    )
