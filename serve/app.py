...
from food_classification import __version__ as _version
from food_classification.config.config import MODEL_SAVE_PATH, PROJECT_NAME, device
from food_classification.predict import load_model, pred_image
