...
unit-tests-cov-report-html:
	@pytest --cov=food_classification --cov-report term-missing --cov-report=html

unit-tests-cov-fail:
	@pytest --cov=food_classification --cov-report term-missing --cov-report=html --cov-fail-under=75
...
lint-mypy:
	@mypy ./food_classification

lint-mypy-report:
	@mypy ./food_classification --html-report ./mypy_html
